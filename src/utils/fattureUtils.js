...
async function creaFatturaElettronica(dati, iscrizione, rinnovo, duplicato) {
    return new Promise(async (resolve, reject) => {
        ...
        .ele('FatturaElettronicaHeader')
            ...
            .ele('CessionarioCommittente')
                .ele('DatiAnagrafici')
                    .ele('CodiceFiscale').txt(dati.codiceFiscaleCliente.trim()).up()
                    .ele('Anagrafica')
                ...
                .up()
                .ele('Sede')
                    .ele('Indirizzo').txt(dati.indirizzoSedeCliente.trim()).up()
                    .ele('CAP').txt(dati.capSedeCliente.trim()).up()
                    .ele('Comune').txt(dati.comuneSedeCliente.trim()).up()
        ...
        .ele('FatturaElettronicaBody')
            ...
            .ele('DatiBeniServizi')
                ...
                .ele('DatiRiepilogo')
                    ...
                    .ele('Imposta').txt(dati.imposta1).up()
                    .ele('EsigibilitaIVA').txt('I').up()
                    .ele('RiferimentoNormativo').txt("Escluso dalla base imponibile art.15").up()
                .up()
                    .ele('DatiRiepilogo')
                    .ele('AliquotaIVA').txt(dati.aliquotaIVARiepilogo1).up()
                    .ele('ImponibileImporto').txt(dati.imponibileImporto1).up()
